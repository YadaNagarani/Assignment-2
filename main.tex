...
\end{align}
\begin{align}
\vec{m_2} = \myvec{-3 \\ 6}-\myvec{2 \\ 5}
\\
\vec{m_2} = \myvec{-5 \\ 1}
\\
\vec{m_2} = \frac{-1}{5}
\\
{\vec{m_1} \times \vec{m_2}} = -1
\\
\vec{m_1} = 5
\end{align}
Given point $\vec{P}$ = $\myvec{-3\\5}$ and  slope $\vec{m_1} = 5$.
The direction vector is $\vec{m_1} = \myvec{1\\5}$.  
Hence, the normal vector

\begin{align}
\label{eq:line_norm_dir}
\vec{n} &= \myvec{0&-1\\1&0}\vec{m_1} 
\\
&= \myvec{-5 \\ 1}
\end{align}
